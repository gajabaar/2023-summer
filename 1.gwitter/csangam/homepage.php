...
// Retrieve the user IDs of the users followed by the current user
$query = "SELECT g.content, u.user_name 
FROM gweet g 
INNER JOIN user u ON g.creator = u.user_id 
WHERE g.creator IN (SELECT user_id FROM follower WHERE follower_id = :userid)";
    ...
    <div class="feed">
      ...
      <div class="tweetBox">
        <form action="gweet.php" method="post">
          ...
          <button class="tweetBox__tweetButton" type="submit">Gweet</button>
        </form>
      </div>
      <!-- tweetbox ends -->
